...
class MatchViewModelTest {
    ...
    private lateinit var detailFetcher: TmdbDetailFetcher
    ...
    fun setUp() {
        ...
        detailFetcher = mockk(relaxed = true)
        context = mockk()
    ...
    private fun newViewModel(): MatchViewModel =
        MatchViewModel(settings, tmdbSearch, tmdbDetail, detailFetcher, context)
