 ...
 * @property type              服务器类型：webdav / openlist。
 ...
 * @property authType          认证类型：auto/basic/digest（auto=自动协商）。仅 WebDAV 后端使用。
...
data class ServerConfigEntity(
    ...
    val name: String,
    @ColumnInfo(defaultValue = "'webdav'") val type: String = "webdav",
    val baseUrl: String,
    val port: Int? = null,
    val rootPath: String = "/",
